...
export const lenspost = [
  {
    ...
    tags: ['Lens', 'Lashes', 'chennai'],
    des:"Lens allow you to express yourself and stand out effortlessly, whether you’re heading to a casual coffee date or a grand reception. Plus, with so many shades to choose from, you’re bound to find one (or ten!) that suit your personality. The best part? You don’t have to be a pro makeup artist to pull off this trend. With a little practice and the right makeup accessories, you can take your look to the next level in no time. So go ahead, try a new shade, and let your eyes do the talking!",
    coverimg:"123main.jpg",
    img1:"",
    comments:"",
    content: [
      {
        subtitle: "Trending Colored Lenses to Match Your Style",
        desc: "Have you ever considered how a simple switch in eye color could transform your entire look? Colored contact lenses are not just a fun accessory—they’re a total game changer! From subtle enhancements to bold, dramatic hues, these little beauties can complement your makeup, mood, or even your outfit. In Chennai, where trends meet tradition, colored lenses are becoming a go-to for makeup enthusiasts looking to up their game. Let’s dive into how you can rock trending colored lenses and match them perfectly with your unique style.",
        parts: [{
          subheader: "Find the Right Shade for Every Occasion",
          desc:[{desc:"Choosing the right colored lens is all about striking a balance between your personal style and the occasion. Want a natural look for a day at work or college? Try soft browns or hazel tones that add a hint of mystery without overpowering your look. For weddings or parties, my client's fashionistas are loving vibrant greens and shimmering grays, which stand out beautifully under bold eye makeup. If you're feeling adventurous, go for daring shades like sapphire blue or violet—perfect for those Instagram-worthy moments!"},
            {desc:"Shopping for makeup accessories in Chennai or Chrompet or Tambaram or Tamilnadhu, especially colored lenses, can be overwhelming with so many options with us, but don’t stress! Start small by experimenting with shades close to your natural eye color before diving into brighter hues. This way, you’ll ease into the trend while finding what truly suits your vibe."}
          ]
        },{
          subheader:"Pair Colored Lenses with Flawless Makeup",
          desc:[{desc:"Your makeup choices can make or break the impact of your colored lenses. Think of your eyes as the canvas and lenses as the masterpiece. A soft pink eyeshadow with brown lenses can create a romantic, understated look. Pair icy gray lenses with smokey eye makeup, and you'll have heads turning in no time. Chennai’s humidity might test your makeup skills, so don’t forget to get our Package in waterproof and sweat-proof products for a lasting finish",
            desc:"If you’re going for vibrant blue lenses, keep your makeup minimal to let your eyes shine. On the flip side, bold lashes with green or hazel lenses can make your eyes pop for glamorous events. Luckily, you can find an amazing range of complementary makeup accessories in our website, from richly pigmented eyeshadows to fluttery false lashes. These products not only elevate your look but also bring out the full potential of your colored lenses."
          }]

        },
        {
          subheader:"Pro Tips for Comfortable and Stylish Wear",
          desc:[
            {desc:"For beginners, wearing lenses might feel a little intimidating. Practice makes perfect! Start by applying your makeup after inserting your lenses to avoid smudges or irritation. If your eyes feel dry, keep a small bottle of rewetting drops handy—especially during those long, humid Chennai days. And here’s a bonus tip: always match your lenses with outfits that complement the vibe. A pastel saree with green lenses or a black gown with gray ones? Perfection!"}
          ]
  ...
  {
    blog_id:"879",
    title: "2 Transform Your Look: Lens and Lash Trends in Chennai",
    coverimg:"123main.jpg",
    category: 'makeup',
    content: [
      {
        subtitle: "2 Trending Colored Lenses to Match Your Style",
        desc: "2 Have you ever considered how a simple switch in eye color could transform your entire look? Colored contact lenses are not just a fun accessory—they’re a total game changer! From subtle enhancements to bold, dramatic hues, these little beauties can complement your makeup, mood, or even your outfit. In Chennai, where trends meet tradition, colored lenses are becoming a go-to for makeup enthusiasts looking to up their game. Let’s dive into how you can rock trending colored lenses and match them perfectly with your unique style.",
        parts: [{
          subheader: "2 Find the Right Shade for Every Occasion",
          desc:["2 Choosing the right colored lens is all about striking a balance between your personal style and the occasion. Want a natural look for a day at work or college? Try soft browns or hazel tones that add a hint of mystery without overpowering your look. For weddings or parties, Chennai’s fashionistas are loving vibrant greens and shimmering grays, which stand out beautifully under bold eye makeup. If you're feeling adventurous, go for daring shades like sapphire blue or violet—perfect for those Instagram-worthy moments!",
            "Shopping for makeup accessories in Chennai, especially colored lenses, can be overwhelming with so many options, but don’t stress! Start small by experimenting with shades close to your natural eye color before diving into brighter hues. This way, you’ll ease into the trend while finding what truly suits your vibe."
          ]
        },{
          subheader:"",
          desc:""
